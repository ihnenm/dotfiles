...
"
" To use a black background, :let g:matt_black_background = 1
...
if ! exists("g:matt_black_background")
    let g:matt_black_background = 1
endif

if has("gui_running")
    if ! g:matt_black_background
    ...
    hi StatusLine     gui=BOLD   guifg=#b9b9b9   guibg=#3e3e5e ctermfg=7 ctermbg=0
    ...
    if ! g:matt_black_background
        ...
        exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(86) . " ctermbg=" . <SID>X(16)
    endif
    ...
    exec "hi LineNr         cterm=NONE   ctermfg=" . <SID>X(82) . " ctermbg=" . <SID>X(80)
    ...
    exec "hi Comment        cterm=NONE   ctermfg=" . <SID>X(08) . " ctermbg=" . "NONE"
    exec "hi Constant       cterm=NONE   ctermfg=" . <SID>X(73) . " ctermbg=" . "NONE"
    exec "hi String         cterm=NONE   ctermfg=" . <SID>X(160) . " ctermbg=" . <SID>X(81)
    exec "hi Error          cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(32)
    exec "hi Identifier     cterm=BOLD   ctermfg=" . <SID>X(54) . " ctermbg=" . "NONE"
    exec "hi Ignore         cterm=NONE"
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(67) . " ctermbg=" . "NONE"
    exec "hi PreProc        cterm=NONE   ctermfg=" . <SID>X(10) . " ctermbg=" . "NONE"
    exec "hi Special        cterm=NONE   ctermfg=" . <SID>X(72) . " ctermbg=" . "NONE"
    exec "hi SpecialChar    cterm=NONE   ctermfg=" . <SID>X(72) . " ctermbg=" . <SID>X(81)
    exec "hi Statement      cterm=BOLD   ctermfg=" . <SID>X(11) . " ctermbg=" . "NONE"
    exec "hi Todo           cterm=BOLD   ctermfg=" . <SID>X(16) . " ctermbg=" . <SID>X(57)
    exec "hi Type           cterm=BOLD   ctermfg=" . <SID>X(39) . " ctermbg=" . "NONE"
